...
def song(client, message):
    ...
    try:
        ...
        m.edit(
            "**ꜰᴏᴜɴᴅ ɴᴏᴛʜɪɴɢ ᴩʟᴇᴀꜱᴇ ᴄᴏʀʀᴇᴄᴛ ᴛʜᴇ ꜱᴩᴇʟʟɪɴɢ ᴏʀ ꜱᴇᴀʀᴄʜ ᴀɴy ᴏɴᴛʜᴇʀ ꜱᴏɴɢ....**"
        )
        print(str(e))
        return
...
async def vsong(client, message: Message):
    ...
    pablo = await client.send_message(
        message.chat.id, f"**ꜰɪɴᴅɪɴɢ yᴏᴜʀ ᴠɪᴅᴇᴏ ᴩʟᴇᴀꜱᴇ ᴡᴀɪᴛ......** `{urlissed}`"
    )
    if not urlissed:
    ...
    try:
        ...
        await event.edit(event, f"**ᴅᴏᴡɴʟᴏᴀᴅ ꜰᴀɪʟᴇᴅ ᴩʟᴇᴀꜱᴇ ᴛʀy ᴀɢᴀɪɴ...♥️** \n**Error :** `{str(e)}`")
        return
    c_time = time.time()
